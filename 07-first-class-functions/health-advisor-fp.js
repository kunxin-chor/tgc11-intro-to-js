...
function calculateBMI(weight, height, bmiFormula) {
    return bmiFormula(weight, height)
}
...
let bmi = 0;
if (unitOfMeasurement == 'M') {
    bmi = calculateBMI(weight, height, function(weight, height){
        return weight/height**2
    });
} else if (unitOfMeasurement=='I') {
    bmi = calculateBMI(weight, height, (w,h)=>{w/h**2*703}) 
}
