async function main() {
  //   let seatingOptions = (await axios.get("seatings.json")).data;
  //   let services = (await axios.get('services.json')).data;

  let seatingRequest = axios.get("seatings.json");
  let serviceRequest = axios.get("services.json");

  // we wait both requests to finish
  let seatingOptions = (await seatingRequest).data;
  let services = (await serviceRequest).data;
